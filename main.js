...
function create(){
    ...
    edgeAsteroids.physicsBodyType = Phaser.Physics.ARCADE;
     ...
     for (var i = 0; i < 50; i++){
        edgeAsteroids.create(i * 110 + game.rnd.integerInRange(0, 30), game.rnd.integerInRange(0, 7) * Math.pow(-1, game.rnd.integerInRange(0, 1)), 'asteroid');
        edgeAsteroids.children[i].body.immovable = true;
        edgeAsteroids.children[i].body.setSize(40, 40, 10, 10);
    }

     for (var i = 0; i < 50; i++){
        edgeAsteroids.create( game.rnd.integerInRange(0, 7) * Math.pow(-1, game.rnd.integerInRange(0, 1)), i * 110 + game.rnd.integerInRange(0, 30), 'asteroid');
